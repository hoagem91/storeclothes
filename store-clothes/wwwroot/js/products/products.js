$(document).ready(function () {
    ...
    $(document).on("click", ".favorite-btn", function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    $btn.toggleClass("favorited"); // Toggle class favorited
                    $btn.attr("title", isFavorited ? "Thêm vào yêu thích" : "Xóa khỏi yêu thích"); // Cập nhật title
...
// Xử lý bộ lọc sản phẩm (kích thước, giá) khi trang được tải
...
// Hàm hiển thị các tùy chọn bộ lọc (kích thước, giá)
...
// Xử lý tìm kiếm và bộ lọc sản phẩm khi người dùng nhập hoặc thay đổi giá trị
document.addEventListener("DOMContentLoaded", function () {
